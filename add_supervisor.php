      ...
      <div class="container mt-5">
        <div class="row">
          <div class="col-lg-6 m-auto bg-light">
            ...
            <form action="add_supervisor_post.php" method="post" enctype="multipart/form-data">


            <div class="form-group my-4">
              <input type="text" name="fname" placeholder="Supervisor name" class="form-control">
            </div>
            <div class="form-group my-4">
              <input type="text" name="email" placeholder="Supervisor email" class="form-control">
            </div>
            <div class="form-group my-4">
              <input type="text" name="employee_ID" placeholder="Employee ID" class="form-control">
            </div>
            <!-- <div class="form-group my-4">
              <input type="text" name="field" placeholder="Enter your field" class="form-control">
            </div> -->
            <div class="form-group my-4">
              <select class="form-control" name="field">
                <option value="">Supervisor field</option>
                <option value="machine_learning">Machine Learning</option>
                <option value="web_design">Web Design</option>
                <option value="computer_vision">Computer Vision</option>
                <option value="artificial_intellegence">Artificial Intelligence</option>
                <option value="argumented_reality">VR and AR</option>
